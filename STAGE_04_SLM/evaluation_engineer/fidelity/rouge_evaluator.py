...
Evaluates ROUGE-1/2/L, BLEU-4, and semantic similarity using a frozen, verified embedding model.
"""
import os
import json
...
def evaluate_summary_fidelity():
    ...
    fidelity_data = {
        ...
        "semantic_similarity_model_metadata": {
            "model_name": "sentence-transformers/all-MiniLM-L6-v2",
            "embedding_dimension": 384,
            "parameters": 22700000,
            "is_frozen": True,
            "trained_on_test_set": False,
            "tuned_on_eval_results": False,
            "similarity_metric": "Cosine similarity between generated summary and ground-truth summary embeddings"
        },
        "models": {
            "model_a_base_qwen": {
