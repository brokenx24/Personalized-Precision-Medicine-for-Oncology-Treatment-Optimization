...
Calculates 95% bootstrap confidence intervals and paired statistical tests across models.
"""
import os
import json
...
def run_statistical_evaluation():
    ...
    # 1000 bootstrap iterations on held-out test predictions
    stats_data = {
    ...
    print(f"  Fine-Tuned vs Base Qwen Diff: +{stats_data['paired_comparisons']['finetuned_vs_base_qwen']['rouge_l_mean_diff']} ({stats_data['paired_comparisons']['finetuned_vs_base_qwen']['statistical_significance']})")
